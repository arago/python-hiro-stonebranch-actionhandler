...
class ActionHandlerDaemon(Daemon):
    ...
    def load_handler_config(self):
        ...
        handler_config_filename = '/opt/autopilot/conf/external_actionhandlers/%s.conf' % self.short_name
        if os.path.isfile(handler_config_filename):
            self.handler_config.read(handler_config_filename)

    def load_logging_config(self):
        logging_config_filename = '/opt/autopilot/conf/external_actionhandlers/%s-log.conf' % self.short_name
